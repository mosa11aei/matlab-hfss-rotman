...
* [ACKNOWLEDGEMENT](#1)
* [Init](#4)
* [Basic input parameters](#5)
* [Antenna elememt spacing](#6)
* [Transmission lines and transitions definition](#7)
* [Dummy port contour parameters](#8)
* [Array and Beam ports phase center correction](#9)
* [Evaluations](#10)
* [Beam port geometry generation](#11)
* [Array port geometry generation](#12)
* [Dummy port geometry generation](#13)
* [Visualization of RL contour and specific points in normalised scale [1/f1]](#14)
* [Visualization of RL vertices numbering in normalized scale [1/f1]](#15)
* [Visualization of RL in real scale [mm] for target Er](#16)
* [Outputs](#17)
## ACKNOWLEDGEMENT
...
save RL\_parameters.tab out  -ascii

out=[X*f1*1000/sqrt(Er),Y*f1*1000/sqrt(Er)];
save RL\_XY\_coordinates\_in\_mm.tab out  -ascii
