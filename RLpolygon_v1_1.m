...
Er=3.66;         %[-] relative permittivity of dielectric substrate
...
ww=1.3655e-3; %[m] transmission line width. Put here the target width of your
...
Lbp=2*lambda0;  %[m]length of taper transition from RL region to TL at BEAM ports
Lap=2*lambda0;  %[m]length of taper transition from RL region to TL at ARRAY ports
Ldp=2*lambda0;  %[m]length of taper transition from RL region to TL at DUMMY ports
